			...
			if (!empty(trim($_POST['dialplan_expression']))) {
				...
				foreach($tmp_array as $dialplan_expression) {
					...
					if (!empty($dialplan_expression)) {
						...
						if ($gateway_type == "gateway") {
							...
							if ($abbrv == "988") {
								...
								$bridge_data = "sofia/gateway/".$gateway_uuid."/".$user_prefix."\$1";
							}
						}
						...
						$dialplan_context = $_POST['context'];
					...
					//build the array - set call_direction
						...
						$array['dialplans'][$x]['dialplan_name'] = $name;
						...
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_data'] = '/usr/share/freeswitch/scripts/trim_number.lua';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_order'] = $y * 10;
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_group'] = '0';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_enabled'] = 'true';
						$y++;
						...
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_tag'] = 'action';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_type'] = 'set';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_data'] = 'cid=${destination_number}${expr(randomize(&x);ceil(random(111111,999999,&x)))}';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_order'] = $y * 10;
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_group'] = '0';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_enabled'] = 'true';
						$y++;
						...
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_tag'] = 'action';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_type'] = 'set';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_data'] = 'origination_caller_id_name=${cid}';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_order'] = $y * 10;
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_group'] = '0';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_enabled'] = 'true';
						$y++;
						...
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_tag'] = 'action';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_type'] = 'set';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_data'] = 'origination_caller_id_number=${cid}';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_order'] = $y * 10;
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_group'] = '0';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_enabled'] = 'true';
						$y++;
						...
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_tag'] = 'action';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_type'] = 'set';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_data'] = 'effective_caller_id_name=${cid}';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_order'] = $y * 10;
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_group'] = '0';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_enabled'] = 'true';
						$y++;
						...
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_tag'] = 'action';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_type'] = 'set';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_data'] = 'effective_caller_id_number=${cid}';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_order'] = $y * 10;
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_group'] = '0';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_enabled'] = 'true';
						$y++;
						...
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_tag'] = 'action';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_type'] = 'set';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_data'] = 'execute_on_answer=record_session $${recordings_dir}/${domain_name}/archive/${strftime(%Y)}/${strftime(%b)}/${strftime(%d)}/${strftime(%Y-%m-%d_%H-%M-%S)}-${sip_to_user}.${record_ext}';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_order'] = $y * 10;
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_group'] = '0';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_enabled'] = 'true';
						$y++;
						...
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_tag'] = 'action';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_type'] = 'set';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_data'] = 'callee_id_numer=$1';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_order'] = $y * 10;
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_group'] = '0';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_enabled'] = 'true';
						$y++;
						...
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_tag'] = 'action';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_type'] = 'set';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_data'] = 'provider_prefix=' . $user_prefix;
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_order'] = $y * 10;
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_group'] = '0';
						$array['dialplans'][$x]['dialplan_details'][$y]['dialplan_detail_enabled'] = 'true';
						$y++;
